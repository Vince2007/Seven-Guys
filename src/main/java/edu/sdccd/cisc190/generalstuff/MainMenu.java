...
public class MainMenu {
    ...
    private Text stats;     // Text to display stats


    /**
     * Updates conviction and madness stats and refreshes the stats text.
     */
    private void updateStats(int convictionDelta, int madnessDelta) {
        conviction += convictionDelta;
        madness += madnessDelta;
    ...
    public MainMenu(Stage primaryStage) {
        ...
        Text description = new Text(
                "You’re the new guy working in Seven Guys, a local burger shop that on the outside, "
                        + "is a fun and exciting place to eat at, filled with yummy food and a huge-ass party stage "
                        + "with cool party rooms, and of course, the main attraction: The High Fives. "
                        + "But behind closed doors, a different story appears.\n"
        ...
        description.setStyle("-fx-font-size: 12px; -fx-font-weight: bold;");
        ...
        // Action for unlocking the door
        startButton.setOnAction(e -> {
            // Use the updateStats method to modify conviction and madness
            updateStats(1, 1);
        ...
        scene = new Scene(layout, 600, 500); // Adjusted size for better readability
    }
